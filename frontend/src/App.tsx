...
function App() {
  ...
  return (
    <div className="min-h-screen w-full p-5 bg-[url('./assets/figurinha.png')] bg-[length:60%] bg-[position:130%_50%] bg-no-repeat  flex flex-col items-center justify-center gap-10">
